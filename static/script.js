...
// Clear error when user picks from dropdown
...
if (registerForm) {
  registerForm.onsubmit = function(e) {
    ...
    if (lastname === '') {
      showError('reg-lastname', 'Last name is required.');
      isValid = false;
    }

    if (firstname === '') {
      showError('reg-firstname', 'First name is required.');
      isValid = false;
    }
    ...
    if (course === '') {
      showError('reg-course', 'Please select a course.');
      isValid = false;
    }

    if (level === '') {
      showError('reg-level', 'Please select a year level.');
      isValid = false;
    }
